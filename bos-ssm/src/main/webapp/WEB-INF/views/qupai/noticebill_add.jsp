...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="${pageContext.request.contextPath }/noticebillController/add"
			 method="post">
						...
						<script type="text/javascript">
							$(function(){
								$("input[name=telephone]").blur(function(){
									...
									//发送ajax请求，提交手机号
									var url = "${pageContext.request.contextPath}/noticebillController/findCustomerByTelephone";
