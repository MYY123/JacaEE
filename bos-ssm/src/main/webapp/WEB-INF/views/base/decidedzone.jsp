...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length == 1){
			...
			var url1 = "${pageContext.request.contextPath}/decidedzoneController/findnoassociCustomers";
			...
			var url2 = "${pageContext.request.contextPath}/decidedzoneController/findhasassociCustomers";
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/decidedzoneController/pageQuery",
			idField : 'id',
			columns : columns,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addDecidedzoneForm" action="${pageContext.request.contextPath }/decidedzoneController/add"
					method="post">
						...
						<td>
							<input class="easyui-combobox" name="staff.id"  
    							data-options="valueField:'id',textField:'name',
    								url:'${pageContext.request.contextPath }/staffListajax'" />  
						</td>
					</tr>
					<tr height="300">
						...
						<td>
							<table id="subareaGrid"  class="easyui-datagrid"
								 border="false" style="width:300px;height:300px"
								  data-options="url:'${pageContext.request.contextPath }/subareaController/listAjax',
	...
	<div class="easyui-window" title="关联客户窗口" modal="true" id="customerWindow" collapsible="false" closed="true" minimizable="false" maximizable="false" style="top:20px;left:200px;width: 400px;height: 300px;">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="customerForm" action="${pageContext.request.contextPath }/decidedzoneController/assignCusToDecizone" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
