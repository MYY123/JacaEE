...
<script type="text/javascript">
	...
	$(function() {
		...
		// 基本功能菜单加载
		$.ajax({
			url : '${pageContext.request.contextPath}/functionController/findMenu',
			type : 'POST',
			//dataType : 'text',
			dataType : 'JSON',
		...
		// 用户角色菜单加载
		$.ajax({
			url : '${pageContext.request.contextPath}/json/userRole.json',
			type : 'POST',
			dataType : 'text',
			success : function(data) {
				var zNodes = eval("(" + data + ")");
				$.fn.zTree.init($("#userRole"), setting, zNodes);
...
<body class="easyui-layout">
	...
	<div data-options="region:'west',split:true,title:'菜单导航'"
		...
		<div class="easyui-accordion" fit="true" border="false">
			...
			<div title="用户角色管理" data-options="iconCls:'icon-mini-add'" style="overflow:auto">  
	...
	<div data-options="region:'center'">
		<div id="tabs" fit="true" class="easyui-tabs" border="false">
			<div title="消息中心" id="subWarp"
				...
				<iframe src="${pageContext.request.contextPath }/home"
		...
		$("#btnEp").click(function(){
			...
			if(v){//表单校验通过
				...
				if(v1 == v2){
					...
					var url = "${pageContext.request.contextPath}/editPassword";
