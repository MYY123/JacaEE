...
<div data-options="region:'center'">
	<form id="functionForm" method="post" action="${pageContext.request.contextPath }/functionController/add">
					...
					<tr>
						...
						<td>
							<input name="function.id" class="easyui-combobox"
							 ...
							 url:'${pageContext.request.contextPath }/functionController/listajax'"/>
						</td>
					</tr>
					<tr>
						<td>描述</td>
